...
public class UserPage {
	...
	private WebElement reg_conform_password_input;
	/**
	 * 注册手机输入框
	 */
	...
	public UserPage(WebDriver driver) {
		...
		reg_input_list.add(reg_conform_password_input);
		reg_input_list.add(reg_cellphone_input);
	}
	/**
	 * 在用户名输入框中输入指定的用户名字符串
	 * @param username 指定的用户名字符串
	 */
	 ...
	 * 检查点，检查必填项是否符合要求
	 * @param index 第几个必填项，从1开始
	 * @param expected 提示的期望文本
	 */
	public void assert_inupt_tip(int index,String expected) {
